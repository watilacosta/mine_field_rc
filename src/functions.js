...
const spreadMines  = (board, minesAmount) => {
  ...
  while(minesPlanted < minesAmount) {
    const rowSel    = parseInt(Math.random() * rows, 10) // Gera valor randômico de base 10 entre 0 e 9
...
const openField = (board, row, column) => {
  ...
  if(!field.opened) {
    ...
    if(field.mined) {
      ...
      // chamada recursiva para abrir os vizinhos se forem seguros
